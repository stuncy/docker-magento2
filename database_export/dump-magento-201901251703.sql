...
-- ------------------------------------------------------
-- Server version	10.2.21-MariaDB-1:10.2.21+maria~bionic-log
...
INSERT INTO `admin_passwords` VALUES (1,1,'a2fa2a3380a7857b91a00080c08a85119a2f33eab1576ef7e423a4c4ce7e650c:vTWUSyaM5tCHBqQunjN5WcNs9Pcpq97j:1',0,1548431845);
...
INSERT INTO `admin_system_messages` VALUES ('da332d712f3215b9b94bfa268c398323',2,'2019-01-25 15:57:38');
...
INSERT INTO `admin_user` VALUES (1,'Sinan','Tuncyurek','sinan@bluebirdday.nl','sinan','a2fa2a3380a7857b91a00080c08a85119a2f33eab1576ef7e423a4c4ce7e650c:vTWUSyaM5tCHBqQunjN5WcNs9Pcpq97j:1','2019-01-25 15:57:25','2019-01-25 15:57:33','2019-01-25 15:57:33',1,0,1,NULL,NULL,NULL,'en_US',0,NULL,NULL);
...
INSERT INTO `admin_user_session` VALUES (1,'0pe9moct88ovvtol2pjiq9hhq5',1,1,'2019-01-25 15:57:34','2019-01-25 15:59:22','127.0.0.1');
...
INSERT INTO `adminnotification_inbox` VALUES (1,4,'2019-01-25 15:51:58','Deprecation Notice','Catalog Search is currently configured to use the MySQL engine, which has been deprecated. Consider migrating to one of\nthe Elasticsearch engines now to ensure there are no service interruptions during your next upgrade.','',0,0);
...
INSERT INTO `authorization_role` VALUES (1,0,1,1,'G',0,'2','Administrators'),(2,1,2,0,'U',1,'2','sinan');
...
INSERT INTO `catalog_category_entity` VALUES (1,3,0,'2019-01-25 15:51:56','2019-01-25 15:51:57','1',0,0,1),(2,3,1,'2019-01-25 15:51:57','2019-01-25 15:51:57','1/2',1,1,0);
...
INSERT INTO `catalog_product_entity` VALUES (1,4,'simple','Test Product',0,0,'2019-01-25 15:59:23','2019-01-25 15:59:23');
...
INSERT INTO `catalog_product_entity_decimal` VALUES (1,77,0,1,15.9500);
...
INSERT INTO `catalog_product_entity_text` VALUES (1,75,0,1,'<p>Dit is een voorbeeld.</p>'),(2,76,0,1,'<p>Dit is een korte omschrijving.</p>'),(3,85,0,1,'Test Product');
...
INSERT INTO `catalog_product_entity_varchar` VALUES (1,73,0,1,'Test Product'),(2,84,0,1,'Test Product'),(3,86,0,1,'Test Product Dit is een voorbeeld.'),(4,106,0,1,'container2'),(5,118,0,1,'0'),(6,121,0,1,'test-product'),(7,132,0,1,'2');
...
INSERT INTO `catalog_product_index_price` VALUES (1,0,1,2,15.9500,15.9500,15.9500,15.9500,NULL),(1,1,1,2,15.9500,15.9500,15.9500,15.9500,NULL),(1,2,1,2,15.9500,15.9500,15.9500,15.9500,NULL),(1,3,1,2,15.9500,15.9500,15.9500,15.9500,NULL);
...
INSERT INTO `catalog_product_index_website` VALUES (1,1,'2019-01-25',1);
...
INSERT INTO `catalogsearch_fulltext_scope1` VALUES (1,73,'Test Product'),(1,74,'Test Product'),(1,75,'Dit is een voorbeeld.'),(1,76,'Dit is een korte omschrijving.'),(1,97,'Enabled'),(1,134,'Taxable Goods');
...
INSERT INTO `core_config_data` VALUES (1,'default',0,'general/region/display_all','1'),(2,'default',0,'general/region/state_required','AU,BR,CA,CH,EE,ES,HR,IN,LT,LV,RO,US'),(3,'default',0,'catalog/category/root_id','2'),(4,'default',0,'analytics/subscription/enabled','1'),(5,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *');
...
INSERT INTO `flag` VALUES (1,'analytics_link_attempts_reverse_counter',0,'24','2019-01-25 15:51:59');
...
INSERT INTO `indexer_state` VALUES (1,'design_config_grid','valid','2019-01-25 15:52:00','34ec592bfa6c952bed4d0a1d58c98770'),(2,'customer_grid','valid','2019-01-25 15:52:00','b9632e06cf957d6e8103eb236ca38cc1'),(3,'catalog_category_product','invalid','2019-01-25 15:51:56','2124d5bfcd83b609c67eee94a0e4708c'),(4,'catalog_product_category','invalid','2019-01-25 15:51:56','77b6356629f3259568a68ea64c773238'),(5,'catalogrule_rule','invalid','2019-01-25 15:51:56','c4f8344a2e6a7d8ebc065631454a4724'),(6,'catalog_product_attribute','invalid','2019-01-25 15:51:56','f73cae77ec4dee3b587a60a2f38dd26a'),(7,'cataloginventory_stock','invalid','2019-01-25 15:51:56','1bf66e64558a5171e523b32f25cb99ca'),(8,'catalog_product_price','invalid','2019-01-25 15:51:56','cbab4723efb02ca24e1db167ef1dfd13'),(9,'catalogrule_product','invalid','2019-01-25 15:51:56','667205576ee3764b1ee81c4a076d10ae'),(10,'catalogsearch_fulltext','valid','2019-01-25 15:51:59','fb6356539c73a2ee336bfb7c3d737d10');
...
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=utf8 COMMENT='List of data/schema patches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `theme` VALUES (1,NULL,'Magento/blank','Magento Blank','preview_image_5c4b309acc308.jpeg',0,'frontend',0,'Magento/blank'),(2,1,'Magento/luma','Magento Luma','preview_image_5c4b309ad5366.jpeg',0,'frontend',0,'Magento/luma'),(3,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend');
...
-- Dump completed on 2019-01-25 17:03:28
